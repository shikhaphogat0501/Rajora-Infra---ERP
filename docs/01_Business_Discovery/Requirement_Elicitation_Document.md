...
Questions Asked
What are the major operational challenges today?
Which departments require the highest level of automation?
What reports are reviewed during management meetings?
What information should be available in real time?
What business improvements are expected after ERP implementation?
Key Findings
...
Can customers reserve multiple units?
What reports are required daily?
Key Findings
...
Which customer documents are maintained?
Key Findings
...
Questions Asked
How are customer payments recorded?
How are outstanding balances monitored?
How are GST calculations performed?
...
Questions Asked
How is construction progress monitored?
Who updates project status?
How are delays identified?
...
Can labour work on multiple projects?
Which reports are required?
Key Findings
...
Questions Asked
How are purchase requests initiated?
How are vendors selected?
Who approves purchases?
How are deliveries monitored?
Key Findings
...
How are material issues recorded?
Which inventory reports are required?
Key Findings
...
Each booking shall have a unique Booking Number.
Customer KYC must be completed before booking confirmation.
Construction shall begin only after required approvals.
Labour wages shall be calculated using approved attendance.
Inventory cannot issue materials exceeding available stock.
Purchase Orders exceeding predefined limits require management approval.
Payment receipts shall be generated automatically for every customer payment.
Construction progress shall be updated stage-wise.
Only authorized users may approve financial transactions.
11. Assumptions
